...
var clearAuthToken = function clearAuthToken() {
  return new Promise(function (resolve, reject) {
    try {
...
var stylesLogin = {"loginContainer":"_2-o_s","loginForm":"_3iMvE","formGroup":"_2zaCv","formActions":"_224Jf","buttonLogin":"_-VX6B"};

var Login = function Login(_ref) {
  var urlLogin = _ref.urlLogin,
    ...
    try {
      return Promise.resolve(_finallyRethrows(function () {
        return _catch(function () {
          ...
          setLoading(true);
          return Promise.resolve(axios.post(urlLogin, {
            username: email,
            password: password
            ...
            var _temp = function () {
              if (response.data.jwt) {
                return Promise.resolve(saveAuthToken(response.data.jwt)).then(function () {
                  onLoginSuccess();
                  setEmail('');
                  setPassword('');
                });
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    className: stylesLogin.loginContainer
  }, /*#__PURE__*/React__default.createElement("div", {
    className: stylesLogin.loginForm
  }, /*#__PURE__*/React__default.createElement("div", {
    className: stylesLogin.formGroup
  }, /*#__PURE__*/React__default.createElement("label", null, "Email Address:"), /*#__PURE__*/React__default.createElement("input", {
    type: "email",
    value: email,
  ...
  })), loading ? /*#__PURE__*/React__default.createElement("div", null, "Loading...") : /*#__PURE__*/React__default.createElement("div", {
    className: stylesLogin.formActions
  }, /*#__PURE__*/React__default.createElement("button", {
    className: stylesLogin.buttonLogin,
    onClick: handleLogin
...
var Register = function Register(_ref) {
    ...
    try {
      ...
      return Promise.resolve(_finallyRethrows(function () {
        return _catch(function () {
          ...
          setLoading(true);
          return Promise.resolve(axios.post(urlRegister, {
            email: email,
            password: password,
            username: email,
            roles: ["ROLE_USER"].concat()
          })).then(function (response) {
  ...
  return /*#__PURE__*/React__default.createElement("div", {
    ...
    onChange: function onChange(e) {
      return setUserData(_extends({}, userData, {
    ...
    className: stylesLogin.formGroup
  }, /*#__PURE__*/React__default.createElement("label", null, "Password Confirm:"), /*#__PURE__*/React__default.createElement("input", {
    type: "password",
  ...
  }, "Sign In"), /*#__PURE__*/React__default.createElement("button", {
    className: stylesLogin.buttonLogin,
    onClick: toggleLogin
  }, "Switch to Login")), /*#__PURE__*/React__default.createElement("p", {
    style: {
      color: 'red'
    }
  }, error)));
...
var Auth = function Auth(_ref) {
  var PageAuthenticated = _ref.PageAuthenticated,
    urlRegister = _ref.urlRegister,
  ...
  React.useEffect(function () {
    var checkAuthStatus = function checkAuthStatus() {
      try {
        return Promise.resolve(isAuthenticated()).then(function (userIsAuthenticated) {
  ...
  var handleToggleLogin = function handleToggleLogin() {
    setIsLogin(function (prevIsLogin) {
      return !prevIsLogin;
    });
  };
  return /*#__PURE__*/React__default.createElement("div", null, loading ? /*#__PURE__*/React__default.createElement("p", null, "Loading...") : /*#__PURE__*/React__default.createElement("div", null, isLogin ? /*#__PURE__*/React__default.createElement(Login, {
