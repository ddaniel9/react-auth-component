...
var _login = _interopRequireDefault(require("./login.css"));
...
var Register = function Register(_ref) {
  ...
  var registerUser = /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var email, password, password_confirmation, response, authResponse;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            email = userData.email, password = userData.password, password_confirmation = userData.password_confirmation;
            _context.prev = 1;
            setLoading(true);

            // Chiamata all'API di registrazione con Axios e l'URL dinamico
            _context.next = 5;
            return _axios["default"].post(urlRegister, {
              email: email,
              password: password,
              username: email,
          ...
          case 5:
            ...
            _context.next = 9;
            return _axios["default"].post(urlLogin, {
              password: password,
              username: email
            });
          case 9:
            ...
            _context.next = 14;
            return (0, _handleJwt.saveAuthToken)(response.data.jwt);
          case 14:
            onRegisterSuccess();
            setUserData({
              email: '',
  ...
  return /*#__PURE__*/_react["default"].createElement("div", {
    className: _login["default"].loginContainer
  }, /*#__PURE__*/_react["default"].createElement("div", {
    className: _login["default"].loginForm
  }, /*#__PURE__*/_react["default"].createElement("div", {
    className: _login["default"].formGroup
  ...
  })), loading ? /*#__PURE__*/_react["default"].createElement("div", null, "Loading...") : /*#__PURE__*/_react["default"].createElement("div", {
    className: _login["default"].formActions
  }, /*#__PURE__*/_react["default"].createElement("button", {
    onClick: registerUser
  }, "Sign In"), /*#__PURE__*/_react["default"].createElement("button", {
    onClick: toggleLogin
  }, "Switch to Login")), /*#__PURE__*/_react["default"].createElement("p", {
    style: {
      color: 'red'
    }
  }, error)));
